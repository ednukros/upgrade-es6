...
const sum = exams.reduce(function (acc, exam) {
...
const approved = exams.reduce(function (acc, exam) {
	if(exam.score > 4){
		return acc + exam.score;
	}else{
		return acc;
...
const media = exams.reduce(function (acc, exam) {
